...
## تحديث 10 سبتمبر 2026 — الأساس المهني للاعب

أضيفت طبقة مهنية مستقلة تربط اللعب المحاسبي بأدلة حقيقية، دون خلط XP أو Coins أو Streak بالسيرة الذاتية:

- Career Profile بخمس خطوات، هوية محلية ثابتة، تعليم وخبرة وتفضيلات عمل وخصوصية.
- Accounting Skill Passport يضم 19 مهارة وحالات Unassessed وPracticed وDemonstrated وVerified المستقبلية فقط.
- Skill Evidence Engine يحول محاولات مستندات First Shift إلى أدلة للمهارات المرتبطة فعلًا، ولا يمنح Verified من اللعب الحالي.
- حساب حتمي للمهارة مع حد أدنى وتنوع في الأنشطة، وAccounting DNA يظهر فقط بعد أدلة كافية.
- جاهزية منفصلة لتسعة أدوار محاسبية بأوزان محفوظة خارج الواجهة.
- Auto CV موجه للدور، A4 Print/Save PDF، وتصدير JSON دون إحصاءات اللعبة.
- Public Talent Profile محلي/تجريبي، إعدادات خصوصية ومعاينة صادقة لما ستراه الشركة مستقبلًا.
- فصل صريح بين Game Profile وCareer Profile، مع انتقال صغير من نهاية First Shift إلى جواز المهارات.
