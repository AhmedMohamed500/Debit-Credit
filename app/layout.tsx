...
export default function RootLayout({ children }: Readonly<{ children: React.ReactNode }>) {
  return <html suppressHydrationWarning><head><script dangerouslySetInnerHTML={{__html:themeBoot}}/></head><body className="min-h-screen bg-daftar-bg text-daftar-text antialiased"><ThemeProvider>{children}</ThemeProvider></body></html>;
}
