...
الملف المعتمد للحالة الحالية بعد إعادة بناء المحتوى والصور هو [سجل Landing Page والتنسيقات](LANDING-PAGE-HISTORY-AND-STYLING-AR.md). التفاصيل أدناه توثق مرحلة V4 السابقة وقد تصف صورًا أو أساليب عرض لم تعد مستخدمة.
