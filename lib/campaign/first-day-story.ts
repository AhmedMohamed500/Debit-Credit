...
export const firstDayIntro={mode:'video',chapterId:'first-day',chapterTitle:w('First Day','أول يوم'),poster:office,video:{},fallbackScenes:[
...
export const firstDayOutro={mode:'scene',chapterId:'first-day-complete',chapterTitle:w('End of Day','نهاية اليوم'),scenes:[
 ...
 {id:'tomorrow',duration:3000,background:office,character:'finance-manager',eyebrow:w('CHAPTER 2 · TEASER','الفصل ٢ · لمحة'),title:w('THE MISSING MONEY','المال المفقود'),dialogue:w('Tomorrow, one number will not match. You will have to find out why.','بكرة رقم واحد مش هيتطابق. ومهمتك تعرف السبب.'),caption:w('Chapter 2 remains locked until review','الفصل ٢ يفضل مقفول لحد المراجعة')},
] } satisfies CinematicChapter;
