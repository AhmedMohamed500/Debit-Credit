...
describe("Debit & Credit Arena accounting engine",()=>{
...
describe("Debit & Credit Arena professional evaluation",()=>{
...
describe("Arena architecture and isolation",()=>{
 ...
 it("uses a Debit & Credit training-only storage key",()=>{expect(ARENA_STORAGE_KEY).toMatch(/^debit-credit-/);expect(ARENA_STORAGE_KEY).not.toContain("accounting-data")});
