...
describe("Debit & Credit Accounting Detective progress and isolation", () => {
  ...
  it("uses a Detective-only key distinct from Missions and the accounting workspace", () => {
    expect(DETECTIVE_STORAGE_KEY).toBe("debit-credit-detective-v1");
    expect(DETECTIVE_STORAGE_KEY).not.toBe("debit-credit-missions-v1");
